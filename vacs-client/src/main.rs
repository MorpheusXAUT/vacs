    ...
    #[cfg(unix)]
    {
        ...
        if matches!(
            ...
            unsafe {
                ...
                // crashes ("Error 71 Protocol error") on Wayland, and blank/gray
                // windows on X11, especially with NVIDIA drivers but also affecting
                // AMD/Intel.
                //
                ...
                // See: https://github.com/tauri-apps/tauri/issues/9394 (X11)
                ...
                // No-op on non-NVIDIA systems and on X11.
