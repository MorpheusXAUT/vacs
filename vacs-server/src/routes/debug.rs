...
pub fn routes() -> Router<Arc<AppState>> {
    Router::new()
        .route("/coverage/station/{station_id}", get(get::station_coverage))
...
mod get {
    ...
    use crate::state::AppState;
    use crate::state::clients::CoverageSnapshot;
    use crate::state::clients::manager::StationCoverage;
    use axum::Json;
    use axum::extract::{Path, State};
    use std::sync::Arc;
    use vacs_protocol::vatsim::StationId;

    pub async fn station_coverage(
